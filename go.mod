...
module github.com/nirs/kubectl-ramen

go 1.19

require (
	github.com/ramendr/ramen v0.0.0-20230825182731-8d2ed78f9b78
...
replace (
	...
	// Ramen dependency - without it we require both gnostic and gnostic-models
